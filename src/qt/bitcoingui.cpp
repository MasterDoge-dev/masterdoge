    ...
    nWeight(0)
{
    ...
    setWindowTitle(tr("MasterDoge") + " - " + tr("Wallet"));
#ifndef Q_OS_MAC
    qApp->setWindowIcon(QIcon(":icons/masterdoge"));
    setWindowIcon(QIcon(":icons/masterdoge"));
#else
    //setUnifiedTitleAndToolBarOnMac(true);
    QApplication::setAttribute(Qt::AA_DontShowIconsInMenus);
#endif
    setObjectName("masterdoge");
    setStyleSheet("#masterdoge { background-color: qradialgradient(cx: -0.8, cy: 0, fx: -0.8, fy: 0, radius: 1.4, stop: 0 #efefef, stop: 1 #dedede);  }");
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setToolTip(tr("Send coins to a MasterDoge address"));
    ...
    masternodeManagerAction = new QAction(QIcon(":/icons/masterdoge"), tr("&MasterDoge Net"), this);
    masternodeManagerAction->setToolTip(tr("Show MasterDoge network nodes status and configure your nodes."));
    ...
    aboutAction = new QAction(tr("&About MasterDoge"), this);
    aboutAction->setToolTip(tr("Show information about MasterDoge"));
    aboutAction->setMenuRole(QAction::AboutRole);
    aboutQtAction = new QAction(tr("About &Qt"), this);
    aboutQtAction->setToolTip(tr("Show information about Qt"));
    aboutQtAction->setMenuRole(QAction::AboutQtRole);
    optionsAction = new QAction(tr("&Options..."), this);
    optionsAction->setToolTip(tr("Modify configuration options for MasterDoge"));
    optionsAction->setMenuRole(QAction::PreferencesRole);
    toggleHideAction = new QAction(QIcon(":/icons/masterdoge"), tr("&Show / Hide"), this);
...
#ifndef Q_OS_MAC
            qApp->setWindowIcon(QIcon(":icons/masterdoge_testnet"));
            setWindowIcon(QIcon(":icons/masterdoge_testnet"));
#else
            MacDockIconHandler::instance()->setIcon(QIcon(":icons/masterdoge_testnet"));
#endif
            if(trayIcon)
            {
                trayIcon->setToolTip(tr("MasterDoge client") + QString(" ") + tr("[testnet]"));
...
void BitcoinGUI::createTrayIcon()
{
    ...
    trayIcon->setToolTip(tr("MasterDoge client"));
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to MasterDoge network", "", count));
}
...
{
    QString strTitle = tr("MasterDoge") + " - ";
...
void BitcoinGUI::dropEvent(QDropEvent *event)
{
    if(event->mimeData()->hasUrls())
    {
        ...
        if (nValidUrisFound)
            ...
            notificator->notify(Notificator::Warning, tr("URI handling"), tr("URI can not be parsed! This can be caused by an invalid MasterDoge address or malformed URI parameters."));
    }
