...
void OptionsModel::Init()
{
    ...
    if (!settings.contains("nAnonymizeMDOGEAmount"))
        settings.setValue("nAnonymizeMDOGEAmount", 1000);

    nDarksendRounds = settings.value("nDarksendRounds").toLongLong();
    nAnonymizeMDOGEAmount = settings.value("nAnonymizeMDOGEAmount").toLongLong();
    ...
    if (settings.contains("nAnonymizeMDOGEAmount"))
        SoftSetArg("-anonymizeMDOGEamount", settings.value("nAnonymizeMDOGEAmount").toString().toStdString());
...
bool OptionsModel::setData(const QModelIndex & index, const QVariant & value, int role)
{
    ...
    if(role == Qt::EditRole)
    {
        ...
        case anonymizeMDOGEAmount:
            nAnonymizeMDOGEAmount = value.toInt();
            settings.setValue("nAnonymizeMDOGEAmount", nAnonymizeMDOGEAmount);
            emit anonymizeMDOGEAmountChanged(nAnonymizeMDOGEAmount);
            break;
