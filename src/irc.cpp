...
void ThreadIRCSeed()
{
    ...
    RenameThread("masterdoge-ircseed");
...
void ThreadIRCSeed2()
{
	...
	int ntimeout = 1000;
        ...
        if (strMyName == "")
            strMyName = strprintf("x%lld", GetRand(1000000000));
        ...
        if (TestNet())
        {
            Send(hSocket, "JOIN #masterdogecoinTEST\r");
            Send(hSocket, "WHO #masterdogecoinTEST\r");
        } else
        {
        LogPrintf("JOIN #masterdogecoin\n");
            // randomly join #masterdogecoin00-#masterdogecoin05
            //int channel_number = GetRandInt(5);

            // Channel number is always 0 for initial release
            int channel_number = 0;
            Send(hSocket, strprintf("JOIN #masterdogecoin%02d\r", channel_number).c_str());
            Send(hSocket, strprintf("WHO #masterdogecoin%02d\r", channel_number).c_str());
        };
