...
const string strMessageMagic = "MasterDoge Signed Message:\n";
...
{
    int64_t nSubsidy = Params().PremineAmount();
    if ((nHeight > Params().PremineBlock()) && (nHeight <= Params().LastPOWBlock()))
...
{
    RenameThread("masterdoge-loadblk");
